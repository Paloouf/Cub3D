...
/*   Updated: 2023/09/25 18:34:21 by jcasades         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_color_f(t_cub *cub, int i , int x)
{
	...
	red = (cub->fl.r_f / (13 - ((i - cub->cam[x].draw_end) / (HEIGHT / 25))));
	blue = (cub->fl.b_f / (13 - ((i - cub->cam[x].draw_end) / (HEIGHT / 25))));
	green = (cub->fl.g_f / (13 - ((i - cub->cam[x].draw_end) / (HEIGHT / 25)))); 
